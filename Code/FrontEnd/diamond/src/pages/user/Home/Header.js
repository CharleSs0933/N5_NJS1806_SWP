    ...
    const Header =() => {
        ...
        const handleLogout = () => {
            ...
            setUser(null)
        alert('LogOut Success'); // Show the success toast
            setTimeout(() => {
            navigate('/');
        ...
        const menuUser = (
            ...
            {user ? (
                <>
                <Menu.Item key="1">
                    <Button onClick={() => navigate('/ManageAccount')} type="text">Manage Account</Button>
                </Menu.Item>
                <Menu.Item key="2">
        ...
        return (
            <div className={`header ${scrolled ? 'scrolled' : ''} ${menuOpen ? 'menu-open' : ''}`}>
                ...
                <button  data-testid="HOME-button" onClick={() => navigate('/')} className={`logo ${scrolled ? 'scrolled' : ''}`}>
            ...
            >
                <Button data-testid="user-dropdown-button" name='btn' type="button" icon={<UserOutlined />} />
            </Dropdown>
            </li>
            <li>
            <Dropdown
                    ...
                    <div className="menu">
                        ...
                        <div className="menu-content">
                            <ul>
                                ...
                                <li>
                                    <div className='menu-items'>
                                        <button onClick={() => navigate('/calculator')} className='btn-menu-items'>
                                            <span className='items'>
                                                <span className='name-item'>Calculator</span>
                                                <span className='direct-item'>
                                                    <span className='direct'> <RightOutlined /></span>
                                                </span>
                                            </span>
